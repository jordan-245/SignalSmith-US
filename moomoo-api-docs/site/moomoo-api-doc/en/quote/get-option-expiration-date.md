...
# <a href="#5686" class="header-anchor">#</a> Get Option Expiration Date
...
- **Description**
  ...
  Query all expiration dates of option chains through the underlying
  stock. To obtain the complete option chain, please use it in
  combination with [Get Option
  Chain](/moomoo-api-doc/en/quote/get-option-chain.html).
...
- **Return**
  ...
  - Option expiration date data format as follows:
    ...
    <td style="text-align: left;">Expiration cycle.
...
## <a href="#4915" class="header-anchor">#</a> Qot_GetOptionExpirationDate.proto
...
message OptionExpirationDate
{
    ...
    optional int32 cycle = 4; //Qot_Common.ExpirationCycle, Index option type. Ignore this parameter for stocks, ETFs and US index options.
}
...
> - For option expiration cycle, refer to
>   [ExpirationCycle](/moomoo-api-doc/en/quote/quote.html#5181)
...
- **Data Type**
  ...
  - For security, refer to
    [Security](/moomoo-api-doc/en/quote/quote.html#5792)
  - For index option type, refer to
    [IndexOptionType](/moomoo-api-doc/en/quote/quote.html#2866)
  - For option expiration cycle, refer to
    [ExpirationCycle](/moomoo-api-doc/en/quote/quote.html#5181)
...
## <a href="#4915-2" class="header-anchor">#</a> Qot_GetOptionExpirationDate.proto
