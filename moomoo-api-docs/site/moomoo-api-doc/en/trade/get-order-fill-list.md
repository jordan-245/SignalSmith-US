...
# <a href="#9411" class="header-anchor">#</a> Get Today's Deals
...
- **Parameters**
  ...
  <ul>
  <li>Return today's deals for the specified market.</li>
  <li>If this parameter is not passed or the default NONE is used, return
  today's deals for all markets.</li>
  </ul>
...
## <a href="#1299" class="header-anchor">#</a> Trd_GetOrderFillList.proto

- **Description**

  Query the transaction list of the specified trading account of the
  day.  
  This feature is only available for live trading and not for paper
  trading.
...
- Today's deals are arranged in chronological order: earlier deals
  return first, followed by later deals.
...
``` python
    code stock_name                            deal_market     deal_id             order_id    qty  price trd_side              create_time  counter_broker_id counter_broker_name status
0  US.AAPL       Apple Inc.                      HK  5056208452274069375  4665291631090960915  100.0  370.0      BUY  2020-09-17 21:15:59.979                  5                         OK)    
4665291631090960915
['4665291631090960915']
```
...
## <a href="#1299-2" class="header-anchor">#</a> Trd_GetOrderFillList.proto
