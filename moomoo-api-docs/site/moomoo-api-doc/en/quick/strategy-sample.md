...
# <a href="#6712" class="header-anchor">#</a> Strategy Setup
...
- The content of this trading strategy is not an investment advice. It
  is for learning purposes only.



## <a href="#7486" class="header-anchor">#</a> Strategy Introduction

Contruct a Double Moving Averaging Strategy.

That is, using the 1 minute candlestick of an underlying stock, to
calculate two moving averages of different periods, MA1 and MA3. The
values of MA1 and MA3 are tracked to determine the timing of buying and
selling.

When MA1 \>= MA3, the underlying stock is judged to be strong and the
market is considered to be a bull market, which shows a long signal.  
When MA1 \< MA3, the underlying stock is judged to be weak and the
market is considered to be a bear market, which shows a short signal.

## <a href="#8601" class="header-anchor">#</a> Flow Chart

![strategy-flow-chart](/moomoo-api-doc/assets/img/strategy-flow-chart.9e0fbe4d.png)

## <a href="#6526" class="header-anchor">#</a> Code Sample
...
## <a href="#7486-2" class="header-anchor">#</a> Strategy Introduction
...
## <a href="#8601-2" class="header-anchor">#</a> Flow Chart

![strategy-flow-chart](/moomoo-api-doc/assets/img/strategy-flow-chart.9e0fbe4d.png)

## <a href="#6526-2" class="header-anchor">#</a> Code Sample
